      ...
      <span className="material-icons"><Image src={manicon3} alt='icon' className='w-[50px] cursor-pointer'></Image></span>
        ...
        <div className='max-w-7xl mx-auto py-10 px-10'>
          ...
          <div className='text-center'>
            ...
            <h1 className='text-6xl font-medium'>Cart</h1>
            <p className='text-xl font-semibold py-5'><span className='font-bold'>Home</span> &gt; Cart </p>
          </div>
          </div>
        </div>
      </div>
      ...
      <div className='max-w-full '>
        <div className='max-w-7xl mx-auto py-10 px-10'>
            <div className='flex justify-between items-start space-x-5'>
                {/* product detail grid  */}
                <div className='grid grid-cols-1 grid-rows-2 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2'>
                    {/* product details  */}
                    {/* 1st row  */}
                ...
                {/* cart total grid  */}
                <div className='grid grid-cols-1 grid-rows-4 lg:grid-cols-1 sm:grid-cols-1 bg-[#fbf3f3]'>
                {/* cart total  */}
