      ...
      <span className="material-icons"><Image src={manicon3} alt='icon' className='w-[50px] cursor-pointer'></Image></span>
        ...
        <div className='max-w-7xl mx-auto py-10 px-10'>
          ...
          <div className='text-center'>
            ...
            <Image src={shopicon} alt='shop icon' className='w-[120px]'></Image>
            </div>
            <h1 className='text-6xl font-medium'>Contact</h1>
            <p className='text-3xl py-5'><span className='font-semibold text-3xl'>Home</span> &gt; Contact </p>
          </div>
          </div>
        </div>
      </div>
      ...
      <div className='max-w-full'>
        <div className='max-w-7xl mx-auto py-10 px-10'>
            ...
            <div className='flex justify-between items-center'>
                ...
                {/* phone  */}
                <div className='w-[420px] space-y-5'>
                    <p className='text-5xl font-semibold'><FontAwesomeIcon icon={faLocationDot} className='mr-5'/>Phone</p>
                    <p className='text-3xl ml-16'>Mobile: +(84) 546-6789</p>
                    <p className='text-3xl ml-16'>Hotline: +(84) 546-6789</p>
                </div>
                {/* work time  */}
                <div className='w-[420px] space-y-5'>
                    <p className='text-5xl font-semibold'><FontAwesomeIcon icon={faLocationDot} className='mr-5'/>Working Time</p>
