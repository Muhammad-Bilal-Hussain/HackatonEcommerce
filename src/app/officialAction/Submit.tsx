...
const createOrderInSanity = async (cartData:productData[], customername: string)=>
{
    try{
        const orderObject ={
            _type:"order",
            ...
            items:cartData.map((item:productData)=>
            (
                {
                    _type:"items",
                    _id: item._id,
...
export default async function Checkout(cartData:productData[], customerInformation:Customer) {
  try{
